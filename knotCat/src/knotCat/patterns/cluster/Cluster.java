...
//TODO import AlgoDBSCAN from the right package
...
public class Cluster {
	 ...
	 * @param vector  the vector to be removed
	 */
	public void removeVector(BitArray vector) {
		vectors.add(vector);
	}
	 ...
	 */
	public boolean contains(BitArray vector) {
